...
- Nightly message-response integrity work is now tracked under `initiatives/conversation-review/`; the downstream execution spec lives in `/mnt/c/git/OpenClawHA/NIGHTLY_CONTEXT_REVIEW.md`, with helper scripts in `/mnt/c/git/OpenClawHA/bin/`.
